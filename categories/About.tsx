	...
	return (
		<>
			<section className='page-padding-x page-padding-y bg-white' id='about'>
				...
				<p className='mb-4'>
					Ik ben erg leergierig en wil graag meer leren over backend development. Ik probeer dagelijks te werken aan frontend en backend roadmaps. Voordat ik veel met backend ga doen wil ik
					eerst goed kunnen werken met een paar frontend frameworks zodat ik goed weet hoe de backend kan worden gebruikt in de frontend.
				</p>
