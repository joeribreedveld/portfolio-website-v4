...
function Hero() {
  return (
    <>
      <section
        className="page-padding-x page-padding-y bg-[url('/img/herobackground.jpg')] text-white min-h-screen flex justify-center items-center flex-col text-center md:text-left"
        id="hero"
      >
