...
function Hero() {
  return (
    <>
      <section
        className="bg-[url('/img/herobackground.jpg')] bg-cover bg-center page-padding-x page-padding-y bg-black text-white min-h-screen flex justify-center items-center flex-col text-center md:text-left"
        id="hero"
      >
